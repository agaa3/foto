...
int main()
{
    ...
    auto matPurple = std::make_shared<DiffuseMaterial>(LightIntensity(.7, .5, 1), LightIntensity(0.5), LightIntensity(.5), LightIntensity(.2), 16);
    ...
    auto matReflective = std::make_shared<ReflectiveMaterial>(0.3);
    auto matRefractive = std::make_shared<RefractiveMaterial>(1.5);


    //LIGHTS
    PointLight light1 = PointLight(Vector3(0, 6.5, 9), LightIntensity(100), 3);
    lights.push_back(&light1);
    PointLight light2 = PointLight(Vector3(0, -3.9, -2), LightIntensity(1, 1, 0.5), 2);
   ...
   Plane plane3 = Plane(Vector3(-4, 0, 0), Vector3(1, 0, 0), matBlue); //z lewej
   objects.push_back(&plane3);

   Plane plane4 = Plane(Vector3(4, 0, 0), Vector3(-1, 0, 0), matRed); //z prawej
