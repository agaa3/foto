...
int main()
{
    ...
    Sphere sfera6 = Sphere(Vector3(1, .5, 3), 1, mat4); //prawa za centralna
    ...
    Triangle triangle5 = Triangle(Vector3(leftX, downY, backZ), Vector3(leftX, upY, backZ), Vector3(rightX, downY, backZ), mat7); //na dole / podloga
    //objects.push_back(&triangle5);

    Triangle triangle6 = Triangle(Vector3(leftX, upY, backZ), Vector3(rightX, upY, backZ), Vector3(rightX, downY, backZ), mat7); //na dole / podloga
